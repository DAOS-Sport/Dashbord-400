...
- 畫面資料應優先吃 BFF section / endpoint：`courts`、`courts`、`/api/courts/xinbei/stats`。
...
- Section key / planned endpoint：employeeSectionKey=`courts`、supervisorSectionKey=`courts`、plannedEndpoint=`/api/courts/xinbei/stats`。
...
| Binding | Value |
| --- | --- |
| employeeSectionKey | courts |
| supervisorSectionKey | courts |
| plannedEndpoint | /api/courts/xinbei/stats |
