...
| --- | --- | --- | --- |
| [[modules/auth|auth]] | employee, lifeguard, supervisor, system, SYSTEM_ADMIN | plannedEndpoint: `/api/auth/me` | 補 `bff.uiStates`、`bff.freshness`、`bff.uiStateSourceFiles`；若同 DTO 跨 section，補 `bff.sharedComponents`。 |
...
| [[modules/supervisor-lifeguard-overview|supervisor-lifeguard-overview]] | supervisor, system | supervisorSectionKey: `lifeguardOverview`<br>plannedEndpoint: `/api/bff/supervisor/lifeguard-overview` | 補 `bff.uiStates`、`bff.freshness`、`bff.uiStateSourceFiles`；若同 DTO 跨 section，補 `bff.sharedComponents`。 |
...
| [[modules/analytics|analytics]] | supervisor, system | supervisorSectionKey: `reports`<br>systemSectionKey: `uiEventOverview`<br>plannedEndpoint: `/api/bff/system/ui-event-overview` | 補 `bff.uiStates`、`bff.freshness`、`bff.uiStateSourceFiles`；若同 DTO 跨 section，補 `bff.sharedComponents`。 |
| [[modules/operations|operations]] | system, supervisor | plannedEndpoint: `/api/bff/supervisor/dashboard` | 補 `bff.uiStates`、`bff.freshness`、`bff.uiStateSourceFiles`；若同 DTO 跨 section，補 `bff.sharedComponents`。 |
| [[modules/counter-log|counter-log]] | supervisor, system | supervisorSectionKey: `counterLog` | 補 `bff.uiStates`、`bff.freshness`、`bff.uiStateSourceFiles`；若同 DTO 跨 section，補 `bff.sharedComponents`。 |
...
| [[modules/courts|courts]] | employee, supervisor, system | supervisorSectionKey: `courts` | 補 `bff.uiStates`、`bff.freshness`、`bff.uiStateSourceFiles`；若同 DTO 跨 section，補 `bff.sharedComponents`。 |
...
| [[modules/handover|handover]] | employee, lifeguard, supervisor | employeeSectionKey: `handover`<br>supervisorSectionKey: `handoverOverview` | 補 `bff.uiStates`、`bff.freshness`、`bff.uiStateSourceFiles`；若同 DTO 跨 section，補 `bff.sharedComponents`。 |
| [[modules/anomalies|anomalies]] | supervisor, system | supervisorSectionKey: `pendingAnomalies`<br>systemSectionKey: `alerts` | 補 `bff.uiStates`、`bff.freshness`、`bff.uiStateSourceFiles`；若同 DTO 跨 section，補 `bff.sharedComponents`。 |
| [[modules/notification-recipients|notification-recipients]] | system, supervisor | plannedEndpoint: `/api/notification-recipients` | 補 `bff.uiStates`、`bff.freshness`、`bff.uiStateSourceFiles`；若同 DTO 跨 section，補 `bff.sharedComponents`。 |
...
| [[modules/personal-note|personal-note]] | employee, lifeguard | employeeSectionKey: `stickyNotes` | 補 `bff.uiStates`、`bff.freshness`、`bff.uiStateSourceFiles`；若同 DTO 跨 section，補 `bff.sharedComponents`。 |
...
| [[modules/checkins|checkins]] | employee | employeeSectionKey: `checkins` | 補 `bff.uiStates`、`bff.freshness`、`bff.uiStateSourceFiles`；若同 DTO 跨 section，補 `bff.sharedComponents`。 |
...
| [[modules/ragic-integration|ragic-integration]] | system, SYSTEM_ADMIN | plannedEndpoint: `/api/auth/me` | 補 `bff.uiStates`、`bff.freshness`、`bff.uiStateSourceFiles`；若同 DTO 跨 section，補 `bff.sharedComponents`。 |
| [[modules/facilities|facilities]] | employee, lifeguard, supervisor, system | plannedEndpoint: `/api/auth/me` | 補 `bff.uiStates`、`bff.freshness`、`bff.uiStateSourceFiles`；若同 DTO 跨 section，補 `bff.sharedComponents`。 |
| [[modules/session-governance|session-governance]] | system, SYSTEM_ADMIN | plannedEndpoint: `/api/auth/me` | 補 `bff.uiStates`、`bff.freshness`、`bff.uiStateSourceFiles`；若同 DTO 跨 section，補 `bff.sharedComponents`。 |
...
| [[modules/supervisor-lifeguard-overview|supervisor-lifeguard-overview]] | 能上線 | 缺 uiStates / freshness；資料層仍 partial/planned；路由仍 partial/legacy | Observer view may claim/dispose lost items through the canonical lost-and-found API. |
| [[modules/analytics|analytics]] | 能上線 | 缺 uiStates / freshness；資料層仍 partial/planned；路由仍 partial/legacy | Analytics reads telemetry/projection state only. |
| [[modules/counter-log|counter-log]] | 能上線 | 缺 uiStates / freshness；路由仍 partial/legacy | 櫃台畫面沿用 supervisor/counter 工作面；不新增 counter role. |
...
| [[modules/personal-note|personal-note]] | 能上線 | 缺 uiStates / freshness；路由仍 partial/legacy | Partial because personal-note is a category, not yet a dedicated module UI. |
...
| [[modules/portal-manage|portal-manage]] | 砍掉重練 / sunset 候選 | 缺 BFF / section contract；缺 uiStates / freshness；路由仍 partial/legacy | Legacy manage route aggregates multiple modules and remains registered as a composite. |
...
| [[modules/gmail-integration|gmail-integration]] | 上線後補 | 缺 BFF / section contract；缺 uiStates / freshness | Partial because SMTP depends on env credentials and has only a test route. |
...
| [[modules/user-role-snapshots|user-role-snapshots]] | 上線後補 | 缺 BFF / section contract；缺 uiStates / freshness；資料層仍 partial/planned | Snapshots are supporting evidence, not an employee-editable surface. |
