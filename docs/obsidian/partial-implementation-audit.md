...
| [[modules/booking-snapshot|booking-snapshot]] | employee, lifeguard, supervisor, system | 上線後補 | 缺 uiStates / freshness；資料層仍 partial/planned |
...
| [[modules/notification-center|notification-center]] | employee, lifeguard, supervisor, system | 上線後補 | 缺 uiStates / freshness；資料層仍 partial/planned |
...
| [[modules/registration-courses|registration-courses]] | employee | 能上線 | 缺 uiStates / freshness；資料層仍 partial/planned；路由仍 partial/legacy |
...
| [[modules/portal-manage|portal-manage]] | supervisor, system | 能上線 | 缺 uiStates / freshness；路由仍 partial/legacy |
...
| [[modules/ragic-integration|ragic-integration]] | system, SYSTEM_ADMIN | 上線後補 | 缺 uiStates / freshness；仍依賴 legacy/proxy endpoint；資料層仍 partial/planned |
| [[modules/gmail-integration|gmail-integration]] | system | 上線後補 | 缺 uiStates / freshness |
...
| [[modules/user-role-snapshots|user-role-snapshots]] | system, SYSTEM_ADMIN | 上線後補 | 缺 uiStates / freshness；資料層仍 partial/planned |
