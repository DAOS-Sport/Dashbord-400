...
const roleDescriptorOverrides: Record<WorkbenchRole, Record<string, Partial<ModuleDescriptor>>> = {
  ...
  lifeguard: {
    ...
    handover: { shortName: "交辦事項", routePath: "/lifeguard/handover", iconKey: "message-square-text", menuOrder: 9, cardOrder: 9, navVisible: true, cardVisible: true },
  ...
  supervisor: {
    ...
    handover: { shortName: "交辦事項", routePath: getPrimaryRoute("handover", "supervisor"), iconKey: "message-square-text", menuOrder: 8, cardOrder: 8, navVisible: true, cardVisible: true },
