...
const employeeNavigationOverrides: Record<string, Partial<ModuleDescriptor>> = {
  ...
  handover: { name: "交接任務", shortName: "交接任務", routePath: getPrimaryRoute("handover", "employee"), iconKey: "message-square-text", menuOrder: 3, cardOrder: 3, navVisible: true, cardVisible: true },
...
const roleDescriptorOverrides: Record<WorkbenchRole, Record<string, Partial<ModuleDescriptor>>> = {
  ...
  lifeguard: {
    ...
    handover: { shortName: "交接任務", routePath: "/lifeguard/handover", iconKey: "message-square-text", menuOrder: 9, cardOrder: 9, navVisible: true, cardVisible: true },
    announcements: { shortName: "群組公告", routePath: "/employee/announcements", iconKey: "bell", menuOrder: 10, cardOrder: 10, navVisible: true, cardVisible: true },
    "employee-training": { shortName: "員工教材", routePath: "/employee/training", iconKey: "graduation-cap", menuOrder: 11, cardOrder: 11, navVisible: true, cardVisible: true },
    "knowledge-base-qna": { shortName: "相關問題詢問", routePath: "/employee/qna", iconKey: "book-open", menuOrder: 12, cardOrder: 12, navVisible: true, cardVisible: true },
  ...
  supervisor: {
    ...
    announcements: { shortName: "公告管理", routePath: getPrimaryRoute("announcements", "supervisor"), iconKey: "bell", menuOrder: 7, cardOrder: 7, navVisible: true, cardVisible: true },
    "announcement-groups": { shortName: "公告群組綁定", routePath: getPrimaryRoute("announcement-groups", "supervisor"), iconKey: "message-square-warning", menuOrder: 8, cardOrder: 8, navVisible: true, cardVisible: true, telemetryEvents: ["PAGE_VIEW", "ACTION_SUBMIT"] },
    "supervisor-lifeguard-overview": { shortName: "救生紀錄總覽", routePath: "/supervisor/lifeguard-overview", iconKey: "lifebuoy", menuOrder: 9, cardOrder: 9, navVisible: true, cardVisible: true },
    handover: { shortName: "交接任務", routePath: getPrimaryRoute("handover", "supervisor"), iconKey: "message-square-text", menuOrder: 10, cardOrder: 10, navVisible: true, cardVisible: true },
  ...
  system: {
    ...
    "linebot-management": { shortName: "400LINE 管理", routePath: "/system/linebot-management", iconKey: "bot", menuOrder: 6, cardOrder: 6, navVisible: true, cardVisible: true, bffEndpoint: "/api/bff/system/linebot-management/overview", telemetryEvents: ["PAGE_VIEW", "LINEBOT_MANAGEMENT_VIEW"] },
    "helper-status": { shortName: "服務監控", routePath: "/system/lineXBS-status", iconKey: "server", menuOrder: 7, cardOrder: 7, navVisible: true, cardVisible: true, bffEndpoint: "/api/bff/system/helper-status", telemetryEvents: ["PAGE_VIEW", "HELPER_STATUS_VIEW"] },
    "line-whitelist": { shortName: "白名單", routePath: "/system/line-whitelist", iconKey: "users", menuOrder: 8, cardOrder: 8, navVisible: true, cardVisible: true, bffEndpoint: "/api/bff/system/line-whitelist", telemetryEvents: ["PAGE_VIEW", "LINE_WHITELIST_VIEW", "LINE_WHITELIST_UPDATED", "CAUTION_PERMISSION_GRANTED"] },
