...
const roleDescriptorOverrides: Record<WorkbenchRole, Record<string, Partial<ModuleDescriptor>>> = {
  ...
  system: {
    ...
    "system-cms-monitoring": { shortName: "400CMS 服務監控", routePath: "/system/400cms/status", iconKey: "server", menuOrder: 6, cardOrder: 6, navVisible: true, cardVisible: true, bffEndpoint: "/api/bff/system/project-monitoring/400cms", telemetryEvents: ["PAGE_VIEW", "MODULE_HEALTH_VIEW"] },
    "linebot-management": { shortName: "400LINE 管理", routePath: "/system/linebot-management", iconKey: "bot", menuOrder: 7, cardOrder: 7, navVisible: true, cardVisible: true, bffEndpoint: "/api/bff/system/linebot-management/overview", telemetryEvents: ["PAGE_VIEW", "LINEBOT_MANAGEMENT_VIEW"] },
    "helper-status": { shortName: "服務監控", routePath: "/system/lineXBS-status", iconKey: "server", menuOrder: 8, cardOrder: 8, navVisible: true, cardVisible: true, bffEndpoint: "/api/bff/system/lineXBS-status", telemetryEvents: ["PAGE_VIEW", "HELPER_STATUS_VIEW"] },
    "line-whitelist": { shortName: "白名單", routePath: "/system/line-whitelist", iconKey: "users", menuOrder: 9, cardOrder: 9, navVisible: true, cardVisible: true, bffEndpoint: "/api/bff/system/line-whitelist", telemetryEvents: ["PAGE_VIEW", "LINE_WHITELIST_VIEW", "LINE_WHITELIST_UPDATED", "CAUTION_PERMISSION_GRANTED"] },
    "system-schedule-control": { shortName: "班表控制中心", routePath: "/system/schedule", iconKey: "calendar-days", menuOrder: 10, cardOrder: 10, navVisible: true, cardVisible: true, bffEndpoint: "/api/bff/system/project-monitoring/schedule", telemetryEvents: ["PAGE_VIEW", "INTEGRATION_STATUS_VIEW"] },
    "system-schedule-monitoring": { shortName: "班表服務監控", routePath: "/system/schedule/status", iconKey: "server", menuOrder: 11, cardOrder: 11, navVisible: true, cardVisible: true, bffEndpoint: "/api/bff/system/project-monitoring/schedule", telemetryEvents: ["PAGE_VIEW", "INTEGRATION_STATUS_VIEW"] },
    "system-collab-course-control": { shortName: "偕同課控制中心", routePath: "/system/collab-course", iconKey: "graduation-cap", menuOrder: 12, cardOrder: 12, navVisible: true, cardVisible: true, bffEndpoint: "/api/bff/system/project-monitoring/collab-course", telemetryEvents: ["PAGE_VIEW", "INTEGRATION_STATUS_VIEW"] },
    "system-collab-course-monitoring": { shortName: "偕同課服務監控", routePath: "/system/collab-course/status", iconKey: "server", menuOrder: 13, cardOrder: 13, navVisible: true, cardVisible: true, bffEndpoint: "/api/bff/system/project-monitoring/collab-course", telemetryEvents: ["PAGE_VIEW", "INTEGRATION_STATUS_VIEW"] },
