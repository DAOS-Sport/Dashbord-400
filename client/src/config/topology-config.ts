...
export const topologyNodes: TopologyNodeDef[] = [
  // 後台管理 admin
  { id: "dashboard",         label: "營運戰情總覽",      englishKey: "dashboard",          group: "admin",  description: "全館總覽與營運 KPI 儀表板", path: "/" },
  { id: "operations",        label: "跨館資源監控",      englishKey: "operations",         group: "admin",  description: "場館人力、資源、營運狀態", path: "/operations" },
  { id: "analytics",         label: "決策與數據洞察",    englishKey: "analytics",          group: "admin",  description: "進階分析與報表", path: "/analytics" },
  ...
  { id: "anomaly-reports",   label: "打卡異常管理",      englishKey: "anomaly-reports",    group: "admin",  description: "異常打卡審核與處理", path: "/anomaly-reports" },
