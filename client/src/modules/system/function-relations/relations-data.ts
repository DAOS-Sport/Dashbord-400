...
export const tableRelationGroups: TableRelationGroup[] = [
  ...
  },
  {
    ...
    description: "員工首頁 BFF 依目前場館組合交辦、班表、公告、文件、便利貼與場租查看。",
    Icon: FileText,
    children: [
      ...
      { table: "employee_resources", relation: "facilityKey + category", feature: "活動檔期、常用文件、便利貼、本地公告", status: "active" },
...
export const featureFlows: FeatureFlow[] = [
  {
    ...
    owner: "employee",
    route: "/employee",
    summary: "登入後依 activeFacility 取首頁 BFF，再把交辦、班表、公告、文件、場租、便利貼組成固定格線。",
...
export const routeRelations: RouteRelation[] = [
  {
    ...
    title: "員工端",
    route: "/employee",
    modules: ["交辦事項", "今日家教預約 placeholder", "群組重要公告", "今日班表", "活動檔期", "常用文件", "場租查看", "便利貼"],
